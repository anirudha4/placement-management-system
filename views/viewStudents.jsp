          ...
          <table class="table table-hover text-center ">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><button class="btn btn-primary validate-btn" id="validate-<%=c%>" onclick="location.href='validateStudent.jsp?id=<%=rst.getString("stud_id").toString()%>'" >Validate</button></td>
              </tr>
