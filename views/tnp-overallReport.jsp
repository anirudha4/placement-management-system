       ...
       Connection con = db.connect();
        ...
        stmt2 = con.createStatement();
         ...
         rst2.next();
           ...
           rst = stmt.executeQuery("SELECT DISTINCT company.comp_id, comp_name, package, COUNT(stud_id) as selected, COUNT(stud_id)*package as total from company INNER join applied on company.comp_id = applied.comp_id where status = 'selected' GROUP BY comp_name");
        ...
        <section id="student-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><%=rst.getString("package").toString()%> LPA</td>
                <td><%=rst.getString("selected").toString()%></td>
...
%>
    ...
    <script>
        function Export(){
            var d = new Date();
            var name = "Placement-Report"+d.getDate()+d.getMonth()+d.getFullYear();
            $("#overall").table2excel({
                filename: name
            });
        }
