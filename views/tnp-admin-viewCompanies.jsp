        ...
        <div class="col-fluid">
          <div class="user">
            <div class="user-logo text-center">
               <%=rst2.getString("name").toString().charAt(0)%>
            </div>
          </div>
         <div class="menu">
              <div class="menu-item">
          ...
          <table class="table table-hover text-center ">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><button class="btn btn-primary validate-btn" id="validate-<%=c%>" onclick="location.href='tnp-viewStudents.jsp?id=<%=rst.getString("comp_id")%>'" >View Students</button></td>
                <td><button class="btn btn-success validate-btn" id="validate-<%=c%>" onclick="location.href='tnp-admin-companyView.jsp?id=<%=rst.getString("comp_id")%>'" >View</button></td>
              </tr>
