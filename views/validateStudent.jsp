...
<html lang="en">
  ...
  <%
    ...
    try{
        ...
        rst2 = stmt2.executeQuery("select name from tnp_coordinator where tnp_id ='"+uname+"' union select name from tnp_admin where tnp_id = '"+uname+"'");
        rst2.next();
  ...
  <body>
    <nav class="nav navbar bg-light">
      ...
      <div class="right-part">
        <div class="nav-item">
            <button class="btn btn-success" id="validate-profile" onclick="location.href='validateStudentProfile.jsp?id=<%=id%>'">Validate</button>
        </div>
